...
```{r fig.height=8, fig.width=25, fig.align='center'}
...
```{r fig.height=13, fig.width=22, fig.align='center'}
...
```{r fig.height=13, fig.width=22, fig.align='center'}
# Checking residuals of seasonally differenced model with P and Q orders - SARIMA(0,0,0)(1,1,2)[11]
BC_sunspot_TS %>% check_residuals(order = c(0,1,0), 
                                  seasonal_order = c(8,1,2),
                                  period = 11,
                                  acf_lag = 50,
                                  pacf_lag = 50,
                                  res_main = 'Figure 11.1: Residuals of seasonally differenced model SARIMA(0,1,0)(1,1,2)[11]',
...
```{r}
model <- Arima(BC_sunspot_TS, order=c(7,1,6), seasonal=list(order=c(1,1,2), period=11))
...
<!-- # ```{r} -->
<!-- # BC_sunspot_TS %>% -->
<!-- #   Arima(order=c(3,0,2), seasonal=c(3,1,2)) %>% -->
<!-- #   forecast(h = 10) %>% -->
<!-- #   autoplot() + -->
